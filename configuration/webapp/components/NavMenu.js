		...
		return (
			...
			<SelectableList
				...
				<List>
					...
					<ListItem primaryText={t('show_tag')} leftIcon={<ContentMail />} style={itemStyles} innerDivStyle={subItemStyle} value="/ensayo/edit" />
					<ListItem primaryText={t('indexed')} leftIcon={<ContentMail />} style={itemStyles} innerDivStyle={subItemStyle} value="/ensayo/edit" />
					<ListItem primaryText={t('today_regist')} leftIcon={<ContentMail />} style={itemStyles} innerDivStyle={subItemStyle} value="/ensayo/edit" />
					<ListItem primaryText={t('add_contact')} leftIcon={<ContentMail />} style={itemStyles} innerDivStyle={subItemStyle} value="/ensayo/edit" />
